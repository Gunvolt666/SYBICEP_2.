          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="VistaLibros.php"><i class="fa fa-circle-o"></i>Libros</a></li>
                 <li><a href="VistaAlumnos.php"><i class="fa fa-circle-o"></i>Usuarios</a></li>
      ...
      <div class="row" style="margin-bottom: 20px">
        ...
        <div class="col-xs-4 form-group">
          <select name="" id="select_status" class="form-control">
            ...
            <option value="1">LOS QUE TIENEN LIBRO</option>
            <option value="0">LOS QUE NO TIENEN LIBRO</option>
          </select>
        </div>
        <div class="col-xs-4 form-group">
          <input type="text" class="form-control" id="txt_busqueda" placeholder="Buscar alumno">
        </div>
      </div>
