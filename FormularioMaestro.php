...
<link rel="stylesheet" type="text/css" href="estilo.css">
    ...
    <body>
     ...
     <div class="contact-form">
       ...
       <div class="txtb">
         <label>Que carrera desempeña</label>
         <input type="text" name="carrera" value="" placeholder="Ingresa la carrera que desempeña en la institucion">
       </div>
       <div class="txtb">
      ...
      <div class="container col-md-12 col-lg-12">
       ...
       <button type="button" class="btn btn-link">Eres Profesor? da click aqui</button>
        </div>
